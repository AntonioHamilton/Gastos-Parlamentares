...
import getMinTypeBillsByCongressman from "@/backend/controllers/ctrMinTypeBillsByCongressman";
...
export default async (req: NextApiRequest, res: NextApiResponse) => {
  ...
  if (req.method === "GET") {
    try {
      ...
      const billsTypes = await getMinTypeBillsByCongressman(Number(year), Number(page), Number(size), String(description));
