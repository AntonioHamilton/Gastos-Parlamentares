...
import getMaxTypeBillsByCongressman from "@/backend/controllers/ctrTypeBillsByCongressman";
...
export default async (req: NextApiRequest, res: NextApiResponse) => {
  ...
  if (req.method === "GET") {
    try {
      ...
      const billsTypes = await getMaxTypeBillsByCongressman(Number(year), Number(page), Number(size), String(description));
