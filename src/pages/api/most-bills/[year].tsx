...
import { getHigherExpensesPerCongressman } from "@/backend/controllers/ctrMostBills";
...
export default async (req: NextApiRequest, res: NextApiResponse) => {
  ...
  if (req.method === "GET") {
    try {
      ...
      const billsTypes = await getHigherExpensesPerCongressman(Number(year), Number(page), Number(size), String(description));
